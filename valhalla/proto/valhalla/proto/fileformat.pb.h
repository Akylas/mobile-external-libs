...
inline void Blob::set_zlib_data(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_zlib_data()) {
    clear_data();
    set_has_zlib_data();
    data_.zlib_data_.InitDefault();
  }
  data_.zlib_data_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Blob::_internal_set_zlib_data(const std::string& value) {
  ...
  data_.zlib_data_.Set(value, GetArenaForAllocation());
}
...
inline void Blob::set_allocated_zlib_data(std::string* zlib_data) {
  ...
  if (zlib_data != nullptr) {
    set_has_zlib_data();
    data_.zlib_data_.InitAllocated(zlib_data, GetArenaForAllocation());
  }
...
inline void Blob::set_lzma_data(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_lzma_data()) {
    clear_data();
    set_has_lzma_data();
    data_.lzma_data_.InitDefault();
  }
  data_.lzma_data_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Blob::_internal_set_lzma_data(const std::string& value) {
  ...
  data_.lzma_data_.Set(value, GetArenaForAllocation());
}
...
inline void Blob::set_allocated_lzma_data(std::string* lzma_data) {
  ...
  if (lzma_data != nullptr) {
    set_has_lzma_data();
    data_.lzma_data_.InitAllocated(lzma_data, GetArenaForAllocation());
  }
...
inline void Blob::set_obsolete_bzip2_data(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_obsolete_bzip2_data()) {
    ...
    data_.obsolete_bzip2_data_.InitDefault();
  }
  data_.obsolete_bzip2_data_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Blob::_internal_set_obsolete_bzip2_data(const std::string& value) {
  ...
  data_.obsolete_bzip2_data_.Set(value, GetArenaForAllocation());
}
...
inline void Blob::set_allocated_obsolete_bzip2_data(std::string* obsolete_bzip2_data) {
  ...
  if (obsolete_bzip2_data != nullptr) {
    set_has_obsolete_bzip2_data();
    data_.obsolete_bzip2_data_.InitAllocated(obsolete_bzip2_data, GetArenaForAllocation());
  }
...
inline void Blob::set_lz4_data(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_lz4_data()) {
    clear_data();
    set_has_lz4_data();
    data_.lz4_data_.InitDefault();
  }
  data_.lz4_data_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Blob::_internal_set_lz4_data(const std::string& value) {
  ...
  data_.lz4_data_.Set(value, GetArenaForAllocation());
}
...
inline void Blob::set_allocated_lz4_data(std::string* lz4_data) {
  ...
  if (lz4_data != nullptr) {
    set_has_lz4_data();
    data_.lz4_data_.InitAllocated(lz4_data, GetArenaForAllocation());
  }
...
inline void Blob::set_zstd_data(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_zstd_data()) {
    clear_data();
    set_has_zstd_data();
    data_.zstd_data_.InitDefault();
  }
  data_.zstd_data_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Blob::_internal_set_zstd_data(const std::string& value) {
  ...
  data_.zstd_data_.Set(value, GetArenaForAllocation());
}
...
inline void Blob::set_allocated_zstd_data(std::string* zstd_data) {
  ...
  if (zstd_data != nullptr) {
    set_has_zstd_data();
    data_.zstd_data_.InitAllocated(zstd_data, GetArenaForAllocation());
  }
...
void BlobHeader::set_indexdata(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 indexdata_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void BlobHeader::_internal_set_indexdata(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  indexdata_.Set(value, GetArenaForAllocation());
}
inline std::string* BlobHeader::_internal_mutable_indexdata() {
  _has_bits_[0] |= 0x00000002u;
  return indexdata_.Mutable(GetArenaForAllocation());
}
inline std::string* BlobHeader::release_indexdata() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = indexdata_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (indexdata_.IsDefault()) {
...
inline void BlobHeader::set_allocated_indexdata(std::string* indexdata) {
  ...
  indexdata_.SetAllocated(indexdata, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (indexdata_.IsDefault()) {
    indexdata_.Set("", GetArenaForAllocation());
  }
