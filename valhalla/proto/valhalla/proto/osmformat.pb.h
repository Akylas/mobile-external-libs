...
void HeaderBlock::set_writingprogram(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 writingprogram_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void HeaderBlock::_internal_set_writingprogram(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  writingprogram_.Set(value, GetArenaForAllocation());
}
inline std::string* HeaderBlock::_internal_mutable_writingprogram() {
  _has_bits_[0] |= 0x00000001u;
  return writingprogram_.Mutable(GetArenaForAllocation());
}
inline std::string* HeaderBlock::release_writingprogram() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = writingprogram_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (writingprogram_.IsDefault()) {
...
inline void HeaderBlock::set_allocated_writingprogram(std::string* writingprogram) {
  ...
  writingprogram_.SetAllocated(writingprogram, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (writingprogram_.IsDefault()) {
    writingprogram_.Set("", GetArenaForAllocation());
  }
...
void HeaderBlock::set_osmosis_replication_base_url(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 osmosis_replication_base_url_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void HeaderBlock::_internal_set_osmosis_replication_base_url(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  osmosis_replication_base_url_.Set(value, GetArenaForAllocation());
}
inline std::string* HeaderBlock::_internal_mutable_osmosis_replication_base_url() {
  _has_bits_[0] |= 0x00000004u;
  return osmosis_replication_base_url_.Mutable(GetArenaForAllocation());
}
inline std::string* HeaderBlock::release_osmosis_replication_base_url() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  auto* p = osmosis_replication_base_url_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (osmosis_replication_base_url_.IsDefault()) {
...
inline void HeaderBlock::set_allocated_osmosis_replication_base_url(std::string* osmosis_replication_base_url) {
  ...
  osmosis_replication_base_url_.SetAllocated(osmosis_replication_base_url, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (osmosis_replication_base_url_.IsDefault()) {
    osmosis_replication_base_url_.Set("", GetArenaForAllocation());
  }
